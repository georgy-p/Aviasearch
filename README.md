...
>Здесь представлен образец документации к SPA-приложению, которое я самостоятельно разработал. Приложение фейковое и не обращается к реальному API, а также имеет скромный функционал. К сожалению, вторая страница с выбором рейса не предполагает никаких действий, кроме кликов по кнопкам с выбором времени, поэтому её описание получилось небольшим.
